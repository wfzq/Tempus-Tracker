...
async function updateMaps() {
    ...
    serverCall.forEach(server => {
        ...
        if (existingElement) {
            ...
            const newThumbnailUrl = `src/data/thumbnails/${server.game_info.currentMap.toLowerCase()}.jpg`;
...
function addServerElement(server) {
    ...
    let thumbnail_url = `src/data/thumbnails/${server.game_info.currentMap.toLowerCase()}.jpg`;
