...
# GUIDE
    Use the variables below to configure the script before running.
    Any intervention inside of the code should only be required
    if the API behavior itself changes
